...
namespace OneStock
{
    internal class SessionMaintenance
    {
        ...
        public static string currentVersion = "1.3.11"; // Current Version of the Application
        public static string appName = "OneStock"; //Name of the Application
        ...
        // Mouse Enter/Leave --------------------------------------------------------------------------------------------------------------
        public static void MouseEnter(Button button)
        {
            button.ForeColor = Color.Black;
            button.BackColor = Color.White;
        }

        public static void MouseLeave(Button button)
        {
        ...
        // Focus Enter/Leave --------------------------------------------------------------------------------------------------------------
        public static void FocusEnter(Control control)
        {
            control.ForeColor = Color.White;
            control.BackColor = Color.Black;
        }

        public static void FocusLeave(Control control)
        {
        ...
        public static void ShowFact()
        {
            ...
            if (factCount < 3)
            {
                ...
                try
                {
                    ...
                    CustomMessageBox messageBox = new CustomMessageBox();
                    messageBox.ClientSize = new Size(401, 600);
